...
describe('RANH GIỚI — hóa đơn KHÔNG được sang luồng khách', () => {
  ...
  it('THIẾU anhClient → KHÔNG đăng ký tool (bot không hứa suông)', () => {
    ...
    // 07/08: +sua_don · 10/08: +3 tool tổng quát · 11/08: +sua_vat,
    // +bao_cao_ban_ton, +tao_don_mua, +tra_nha_cung_cap (phiếu nhập hàng)
    expect(r.definitions()).toHaveLength(25); // 17/08: +tra_ngan_hang; 25/08: +doanh_so_khach_theo_thang; 26/08: +lai_gop_khach
  });
