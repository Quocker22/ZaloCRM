...
export function buildRagSystemPrompt(
  ...
  return [
    ...
    '  "LẤY HẾT"/"còn nhiêu lấy hết" → dùng SỐ TỒN KHO trong tài liệu làm qty (nếu tài liệu có tồn). KHÔNG chặn đơn',
    '    vì vượt tồn — cứ chốt theo số khách muốn; sale lo phần chuẩn bị hàng.',
