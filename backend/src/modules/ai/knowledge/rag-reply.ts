...
export function buildRagSystemPrompt(
  ...
  return [
    ...
    '    ("chắc chắn có giá tốt", "không dùng giá niêm yết", "có áp dụng mức giảm", "nguyên thùng sẽ có chính',
    '    sách hỗ trợ giá"...). Chỉ được nói mức giảm CÓ THỂ sale XEM XÉT theo số lượng. reply: "Dạ mức giảm tùy',
